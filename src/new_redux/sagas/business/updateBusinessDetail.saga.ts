...
function* updateBusinessDatailRequestSaga(
  action: PayloadAction<AppActionTypes.Business.IUpdateBusinessDetailRequestAction>
) {
  try {
    ...
    yield put(AppActions.business.updateBusinessDetailSuccess(result.data));
...
export default (function* () {
  yield takeLatest(
    "business/updateBusinessDetailRequest",
    updateBusinessDatailRequestSaga
  );
})();
