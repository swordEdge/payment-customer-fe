...
function* updateBusinessAddressRequestSaga(
  action: PayloadAction<AppActionTypes.Business.IUpdateBusinessAddressRequestAction>
) {
  try {
    ...
    const result: ResponseGenerator = yield call(async () => {
      return await makeAPIRequst(
        'business-customer-corporation/address',
        "PUT",
    ...
    yield put(AppActions.business.updateBusinessAddressSucess(result.data));
...
export default (function* () {
  yield takeLatest(
    "business/updateBusinessAddressRequest",
    updateBusinessAddressRequestSaga
  );
})();
