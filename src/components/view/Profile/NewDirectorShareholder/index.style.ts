...
type NewDirectorShareholderViewStyleProps = StyledComponentProps & {};

export const NewDirectorShareholderViewStyle = styled('div')<NewDirectorShareholderViewStyleProps>(
  ({ theme }) => {
