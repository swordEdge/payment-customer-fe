...
type UpdateOrderConfirmComponentStylerops = StyledComponentProps & {};

export const UpdateOrderConfirmComponentStyle = styled(
  'div'
)<UpdateOrderConfirmComponentStylerops>(({ theme }: any) => {
